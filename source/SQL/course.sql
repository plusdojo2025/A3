...
INSERT INTO course VALUES
  (NULL, 'A', '和', '和装レンタル、和風装花など、日本の文化や伝統や、和の要素を取り入れた和婚式スタイル', '1', '2', '3'),
  (NULL, 'B', '洋', '白を基調とした厳かな挙式、バージンロードの入場、会場などロマンチックな雰囲気', '1', '2', '3'),
  (NULL, 'C', '和洋', '和の伝統美と洋の華やかさが調和し、どちらも楽しめる和洋折衷ウェディング', '1', '2', '3');
